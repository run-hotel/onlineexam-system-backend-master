...
public class AdminSubjectController {
  ...
  @RequestMapping(value = "/insertConnectTeacherStudentClassInfo", method = RequestMethod.POST)
  public ServerResponse insertStudentInfo(@RequestBody(required = false) ConnectTeacherStudentclass connectteacherstudentclass) {
...
//    connectteacherstudentclass.setStuCreateTime(new Date());
    int result = connectTeacherStudentService.insertConnectTeacherStudentclassInfo(connectteacherstudentclass);
    if (result > 0) {
